...

{
  ...
  xdg.configFile."deej/config.yaml".text = ''
    ...
    slider_mapping:
      ...
      2: firefox
      3: discord
      4: [Warframe.x64.exe, Kiwi Clicker.exe, steam]
    ...
    # For Steam/Proton games, you can use multiple names in an array: [game.exe, steam]
    # The script will control volume for all running applications that match
